    ...
    public class PipelineHistoryApplicationAutoMapperProfile : Profile
    {
        public PipelineHistoryApplicationAutoMapperProfile()
        {
            ...
            CreateMap<PipelineHistory, PipelineHistoryDetailDto>()
                .ForMember(d => d.StartTime, map => map.MapFrom(s => (s.StartTime == null) ? "" : ((DateTime)(s.StartTime)).ToString("yyyy-MM-dd HH:mm:ss")))
                .ForMember(d => d.CompletionTime, map => map.MapFrom(s => (s.CompletionTime == null) ? "" : ((DateTime)(s.CompletionTime)).ToString("yyyy-MM-dd HH:mm:ss")))
